...
::: info Not yet in code
The translation delivery structure is defined here but not yet implemented. The folder-based layout below is conceptual — remote-settings uses a flat collection-of-records model with attachments, and the actual structure needs to be validated against remote-settings capabilities before implementation.
:::
