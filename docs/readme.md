...
> These docs are also available as **[deployed pages →](https://mozilla.github.io/home-new-tab/)**
...
- [Mental Model](architecture/mental-model.md)
...
- Subsystems
  ...
  - [Publish Pipeline](architecture/publish-pipeline.md)
...
- Reference
  ...
  - [API Surfaces](spec/api-surfaces.md)
  - [File Map](spec/file-map.md)
