      ...
      setPreferences: (patch) => {
        return commit((state) => {
          ...
          const same =
            ...
            nextPrefs.autoSwitchEnabled ===
              state.preferences.autoSwitchEnabled &&
            nextPrefs.autoStartNextPhase ===
              state.preferences.autoStartNextPhase
...
export const useTimerStore = timer._unsafe_useStore
